...
with st.sidebar:
    ...
    art_path = Path("/mnt/user-data/uploads/IMG20260430095628.jpg")
    if art_path.exists():
...
with tabs[5]:
    ...
    st.markdown(f"<div style='font-family:\"Space Mono\",monospace; font-size:10px; color:#1AE8A0; letter-spacing:0.18em; text-transform:uppercase; margin-bottom:12px;'>⭐ {t('Featured: Builder\\'s Proof of Work','فیچرڈ: بلڈر کا Proof of Work')}</div>", unsafe_allow_html=True)
